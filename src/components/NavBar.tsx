...
import { FaHome, FaBriefcase, FaTools, FaProjectDiagram, FaFileAlt, FaAddressBook } from 'react-icons/fa'; // Import icons
import './Navbar.css';
    ...
    <>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul>
          ...
          <li><Link to="/resume" onClick={closeSidebar}><FaFileAlt /> Resume</Link></li>
          <li><Link to="/contact" onClick={closeSidebar}><FaAddressBook /> Contact</Link></li>
        </ul>
      </div>
    </>
  );
